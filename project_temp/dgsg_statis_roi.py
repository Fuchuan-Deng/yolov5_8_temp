...
def convert_annotation(image_id):
    in_file = open('/data1/dataset_duangusuangu/Annotations/%s.xml' % (image_id), encoding="utf-8")
    ...
    if w < 1280 and h < 1280:
        print(image_id, "w and h smaller than 1280")
    ...
    if flag is False:
        print(image_id, xmax - xmin, ymax - ymin)
        if xmax - xmin > 1280 or ymax - ymin > 1280:
            return 1
        else:
            return 0
    return 0
...
if __name__ == "__main__":
    file_path = '/data1/dataset_duangusuangu/shai/Annotations'
    ...
    for xml_file in xml_list:
        ...
        count = count + convert_annotation(xml_file[:-4])
    print("The count is ", count)
    print("The len is ", len(xml_list))