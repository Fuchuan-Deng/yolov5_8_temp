...
def rename_img_label(img_dir, xml_dir):
    ...
    for i, img_file in enumerate(image_files):
        ...
        if img_file.split('.')[0] in img_files and img_file.split('.')[0] in xml_files:
            ...
            new_xml_file = "%06d.txt" % (i+1)
            new_xml_file = os.path.join(xml_dir, new_xml_file)

            old_xml_file = img_file.split('.')[0] + ".txt"
...
if __name__ == "__main__":
    img_dir = "/data1/dataset_duangusangu_seg/data/train/images/train2017"            # 55464
    xml_dir = "/data1/dataset_duangusangu_seg/data/train/labels/train2017"    # 27732
