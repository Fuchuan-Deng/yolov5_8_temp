...
if __name__ == "__main__":
    file_path = r'/data1/dataset_duangusangu_seg/data/train/labels/train2017'
    imgs_path = r"/data1/dataset_duangusangu_seg/images"
    save_path = r"/data1/dataset_duangusangu_seg/data/train//images/train2017"
